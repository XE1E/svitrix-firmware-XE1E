...
| **Air Quality (AQI)** | Індекс якості повітря (US EPA, 1–6). Автоколір за рівнем (зелений → жовтий → помаранчевий → червоний) або фіксований колір. Коли перемикач автокольору увімкнено, колір рівня має пріоритет і перекриває будь-який фіксований колір чи колір елемента (нічний режим усе одно діє). |
...
Застосунок «Місяць» показує поточну **фазу Місяця** — намальований Місяць у відтінках сірого (реалістичне затінення, м'який термінатор і слабке *earthshine* на темному боці) на тлі мерехтливих синіх зірок.
