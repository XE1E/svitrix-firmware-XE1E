export const translations = {
  es: {
    ...
    apps: {
      ...
      moon: "Luna",
      moonTitle: "Luna (fases lunares)",
      moonHemisphere: "Hemisferio",
      moonNorth: "Norte",
      moonSouth: "Sur",
      moonInfoHint: "Texto que rota junto a la luna (si desactivas todo, solo se muestra la luna).",
  ...
  en: {
    ...
    apps: {
      ...
      moon: "Moon",
      moonTitle: "Moon (lunar phases)",
      moonHemisphere: "Hemisphere",
      moonNorth: "Northern",
      moonSouth: "Southern",
      moonInfoHint: "Text that rotates next to the moon (disable all to show the moon only).",
