export const translations = {
  es: {
    ...
    display: {
      ...
      colorTintHint: "Tinte global de toda la pantalla. Blanco = sin cambio; solo puede atenuar canales de color, no añadirlos. Usa colores saturados para notar el efecto.",
      reset: "Restablecer",
      tempWarm: "Cálido",
      tempNeutral: "Neutro",
      tempCool: "Frío",
    ...
    apps: {
      ...
      moon: "Luna",
      moonHemisphere: "Hemisferio",
      moonNorth: "Norte",
      moonSouth: "Sur",
      moonShowName: "Mostrar nombre de fase",
      moonShowAge: "Mostrar edad lunar",
      moonShowIllum: "Mostrar % de iluminación",
      ...
      appDuration: "Duración por defecto",
      ...
      durationStepHint: "toca = ±1s · mantén = ±10s · 0 = usa la duración por defecto",
      default: "Por defecto",
    ...
    sound: {
      ...
      melodyLoaded: "Cargada en el editor",
      editFailed: "No se pudo cargar la melodía",
    ...
    alarms: {
      ...
      melodyPresets: "Predefinidas",
      melodyFiles: "Archivos (/MELODIES)",
  ...
  en: {
    ...
    display: {
      ...
      colorTintHint: "Global tint applied to the whole screen. White = no change; it can only dim color channels, not add them. Use saturated colors to see the effect.",
      reset: "Reset",
      tempWarm: "Warm",
      tempNeutral: "Neutral",
      tempCool: "Cool",
    ...
    apps: {
      ...
      moon: "Moon",
      moonHemisphere: "Hemisphere",
      moonNorth: "Northern",
      moonSouth: "Southern",
      moonShowName: "Show phase name",
      moonShowAge: "Show lunar age",
      moonShowIllum: "Show illumination %",
      ...
      appDuration: "Default app duration",
      ...
      durationStepHint: "tap = ±1s · hold = ±10s · 0 = use the default duration",
      default: "Default",
      resetDefaults: "Reset",
    ...
    sound: {
      ...
      melodyLoaded: "Loaded into editor",
      editFailed: "Could not load melody",
